...
Generic recipes — apply to any Frictionless package, not just GMNS. For GMNS-specific recipes (network-aware scope, quality rules, editing, MCP), see the [gmnspy cookbook](https://e-lo.github.io/GMNSpy/gmnspy/cookbook/).
