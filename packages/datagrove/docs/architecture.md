...
For the **GMNS data model** (link/node/lane/etc. ER diagrams), see [gmns-data-model.md](https://e-lo.github.io/GMNSpy/gmnspy/gmns-data-model/). The full PRD with personas, requirements traceability, and roadmap will land in Phase 4 task 4.15 (tracked in the [v1.0 epic](https://github.com/e-lo/GMNSpy/issues/115)).
...
- **Backwards compat:** v0.3.x is a clean break — no shims. Migration guide ([docs/migration/v0.3-to-v1.0.md](https://e-lo.github.io/GMNSpy/gmnspy/migration/v0.3-to-v1.0/), Phase 4 task 4.14) explains old → new mappings.
...
Full contributor workflow: [CONTRIBUTING.md](https://github.com/e-lo/GMNSpy/blob/main/CONTRIBUTING.md).

---

*This document is updated as architectural decisions evolve. When updating, also update the [GitHub issue tree](https://github.com/e-lo/GMNSpy/issues/115) and (post-Phase-4) the PRD. Authoritative source for any conflict: this file > PRD > issue body > inline code comments.*
