...
def test_scope_shares_graph_cache_with_semantics():
    """scope + semantics share a single GMNSGraph build via _cached_gmnsgraph."""
    from gmnspy.scope.scope import _GRAPH_CACHE_KEY as scope_key
