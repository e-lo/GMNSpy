...
* [Architecture](https://e-lo.github.io/GMNSpy/datagrove/architecture/) — MCP server position in the v1.0 surface layering.
* [Drive the CLI from an AI agent loop](https://e-lo.github.io/GMNSpy/datagrove/ai/json-cli/) — when you want an agent to drive `gmnspy` via shell instead of MCP.
