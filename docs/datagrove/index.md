...
A generic engine for tabular data packages in the [Frictionless](../shared/concepts/frictionless.md) format. Lazy by default, regional-scale ready, with composable primitives for validation, scope, editing, and serving.
...
-   :material-architecture:{ .lg .middle } &nbsp;**Architecture**
    ...
    [:octicons-arrow-right-24: Architecture](../shared/architecture.md)
