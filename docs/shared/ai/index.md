...
Tools shipped (full reference: [MCP tools](../../gmnspy/ai/mcp-tools.md)):
...
* **Stable schemas** — same shape across versions inside a major. `ValidationReport`, `EditResult`, and the per-command summary dicts are documented in the [API reference](../../gmnspy/reference/api.md).
...
* [Migration guide](../../gmnspy/migration/v0.3-to-v1.0.md#whats-new) — what's new vs v0.3 from an AI consumer's standpoint.
