...
For the **GMNS data model** (link/node/lane/etc. ER diagrams), see [gmns-data-model.md](../gmnspy/gmns-data-model.md). For the full PRD with personas, requirements traceability, and roadmap, see [PRD.md](PRD.md) (written in Phase 4 task 4.15).
...
- **Backwards compat:** v0.3.x is a clean break — no shims. Migration guide ([docs/migration/v0.3-to-v1.0.md](../gmnspy/migration/v0.3-to-v1.0.md), Phase 4 task 4.14) explains old → new mappings.
